/**\file cube_marker.h
 * \brief File with cube_marker class declaration
 *
...
#ifndef ROS_MARKER_PUBLISHER_CUBE_MARKER_H
#define ROS_MARKER_PUBLISHER_CUBE_MARKER_H
...
#endif //ROS_MARKER_PUBLISHER_CUBE_MARKER_H
