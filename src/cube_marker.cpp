/**\file cube_marker.h
 * \brief File with cube_marker class definition
 *
...
namespace marker_publisher {
    ...
    void CubeMarker::setupMarkerConfigurationFromParameterServer(ros::NodeHandlePtr& _node_handle, ros::NodeHandlePtr& _private_node_handle,
